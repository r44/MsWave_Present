...
data = (spio.loadmat(HomePath+'Dataset/Sound/Parsed/mvd'))['data']
...
WeightPath = HomePath+'trans_sound/1/500_1900/'
OutPath = HomePath+'Results/Exp0623/sound_mvd/'
...
OutFile = OutPath+str('0623_01.csv')
